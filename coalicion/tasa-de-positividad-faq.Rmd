...
Como sabemos que hay más muertes cuando hay más casos, y que por lo general estas ocurren alrededor de 1-2 semanas luego de la infección, estos resultados implican que hasta ahora la tasa de positividad ha subido cuando los casos suben y bajado cuando los casos bajan. 
...
* En Massachusetts se están haciendo alrededor de 100,000 pruebas moleculares al día, mientras que en Puerto Rico solo se hacen alrededor de 5,000. Por lo tanto, aunque reporten muchos más casos, Massachusetts no necesariamente tiene muchos más contagiados, si no que están haciendo muchas más pruebas.
