...
Este documento fue escrito para ayudar a aclarar la confusión que hay sobre la tasa de positividad y explicar como la [Coalición Científica de Puerto Rico](https://sites.google.com/view/coalicion-cientificapr/home) usa la métrica. Haga clic en la pregunta para ver la contestación.
...
La tasa de positividad se define de dos formas:
...
Aquí nos referimos a estas dos versiones como _% pruebas_ y _% casos_, respectivamente. En la sección _Por qué se reportan distintas tasas de positividad_ explicamos las diferencias, pero ambas son útiles. 
...
Aunque que no hay garantía de que los datos continuarán siguiendo el mismo patrón en el futuro, este es el mejor estimado con la información que tenemos ahora. Continuaremos estudiando los datos cuidadosamente.
...
No siempre es recomendado hacer comparaciones directas ya que la tasa de positividad es afectada por varios factores que pueden ser únicos a cada jurisdicción. Para empezar hay que estar seguro que se está usando la misma definición en ambas jurisdicciones ya que varía. El hecho que algunas jurisdicciones hacen muchísimas mas pruebas que en Puerto Rico hace que sus tasas sean más bajas. Por último, para la tasa basada en pruebas, el por ciento de personas que se hacen múltiples pruebas puede afectar la tasa de positividad.
