...
fn <- "data/Vacunas (Raw Data - Clean) 07-11-2021.csv"
library(tidyverse)
library(readxl)
library(lubridate)
library(tidycensus)
...
Departamento de Salud por proveer datos y Enrique Volckers y Eduardo Zavala por facilitar el traslado de datos.

\@midnucas proveyó recomendaciones y reportó errores.
