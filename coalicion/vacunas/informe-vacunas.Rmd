...
## Dosis completa por fecha por grupo demográfico
...
\newpage
## Primera dosis por fecha por grupo de edad
...
```{r}
dat %>%
  filter(!is.na(ageRange) & date < max(date) - weeks(1)) %>%
