...
tab <- data.frame(
  Metrica = paste0(c("% pruebas positivas", "% casos nuevos", "Hospitalizaciones", "% con vacunación al día", "% con serie primaria completa",  "% por lo menos 1 dosis"), "&nbsp;"),
  valor = c(res$positividad, res$casos_positividad, res$hosp, res$vacuna_al_dia, res$vacunas, res$una_dosis))
...
* **%con vacunación al día** = Por ciento de la poblacion con el booster o con dosis completa y sin necesidad de booster.

* **% población con serie primaria completa** = Por ciento de la población de Puerto Rico que ha recibido las primeras dos dosis de la vacuna (o la primera de J&J).
