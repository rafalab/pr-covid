...
tab <- data.frame(Metrica = c("% pruebas positivas", "% casos nuevos", "Hospitalizaciones", "% población vacunada", 
                              "Días para alcanzar 70%"),
                  valor = c(res$positividad, res$casos_positividad, res$hosp, res$vacunas, res$dias_hasta_meta_vacuna))
...
Calculamos las tasas de positividad y número de pruebas con pruebas moleculares. Los casos son detectados con pruebas moleculares y de antígeno.
...
* **Casos** = casos nuevos únicos, o sea personas que salieron positivo por primera vez esa semana. Comenzando el 15 de febrero de 2020 incluimos casos detectados con pruebas de antígenos.
