...
## Read-in sheets
fn <- "data/20_0615-Grafica y Tablas Pruebas Moleculares COVID- semana 12 julio.xlsx"
...
save(pr_by_lab, file = "rdas/pr_by_lab-2020-07-12.rda")
...
save(pr, file = "rdas/pr-2020-07-12.rda")
